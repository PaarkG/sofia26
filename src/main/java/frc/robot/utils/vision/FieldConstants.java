...
public class FieldConstants {
    ...
    public static class LinesVertical {
        ...
        public static final double starting = AprilTagLayoutType.ANDYMARK.getLayout().getTagPose(26).get().getX();
        public static final double allianceZone = starting;
        public static final double hubCenter = AprilTagLayoutType.ANDYMARK.getLayout().getTagPose(26).get().getX()
                + Hub.width / 2.0;
        ...
        public static final double oppHubCenter = AprilTagLayoutType.ANDYMARK.getLayout().getTagPose(4).get().getX()
                + Hub.width / 2.0;
        public static final double oppAllianceZone = AprilTagLayoutType.ANDYMARK.getLayout().getTagPose(10).get()
                .getX();
    }
    ...
    public static class Hub {
        ...
        // Hub faces
        public static final Pose2d nearFace = AprilTagLayoutType.ANDYMARK.getLayout().getTagPose(26).get().toPose2d();
        public static final Pose2d farFace = AprilTagLayoutType.ANDYMARK.getLayout().getTagPose(20).get().toPose2d();
        public static final Pose2d rightFace = AprilTagLayoutType.ANDYMARK.getLayout().getTagPose(18).get().toPose2d();
    ...
    public static class Outpost {
        ...
        public static final Translation2d centerPoint = new Translation2d(0,
                AprilTagLayoutType.ANDYMARK.getLayout().getTagPose(29).get().getY());
    ...
    public static class AprilTags {
        public static final List<AprilTag> globalTags = AprilTagFieldLayout
                .loadField(AprilTagFields.k2026RebuiltAndymark).getTags();
        public static final List<AprilTag> blueHubTags = AprilTagFieldLayout
                .loadField(AprilTagFields.k2026RebuiltAndymark).getTags().stream()
                .filter((AprilTag tag) -> List.of(18, 19, 20, 21, 24, 25, 26, 27).contains(tag.ID))
                .toList();
        public static final List<AprilTag> redHubTags = AprilTagFieldLayout
                .loadField(AprilTagFields.k2026RebuiltAndymark).getTags().stream()
                .filter((AprilTag tag) -> List.of(2, 3, 4, 5, 8, 9, 10, 11).contains(tag.ID))
                .toList();
        public static final List<AprilTag> blueTowerTags = AprilTagFieldLayout
                .loadField(AprilTagFields.k2026RebuiltAndymark).getTags().stream()
                .filter((AprilTag tag) -> List.of(31, 32).contains(tag.ID))
                .toList();
        public static final List<AprilTag> redTowerTags = AprilTagFieldLayout
                .loadField(AprilTagFields.k2026RebuiltAndymark).getTags().stream()
